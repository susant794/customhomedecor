  ...
  return (
    <div className="bg-brand-light">
      <div className="container mx-auto px-6 py-24">
        ...
        >
          <motion.h1 variants={itemVariants} className="font-serif text-4xl sm:text-5xl font-bold text-brand-dark">
            Get in Touch
          </motion.h1>
          ...
          >
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg flex items-start space-x-6">
              ...
              <div>
                ...
                <a href="mailto:contact@customhomedecor.com" className="mt-1 text-brand-teal hover:underline">
                  {`${environment?.email}`}
                </a>
              </div>
            </div>
            <div className="bg-white p-8 rounded-lg shadow-lg flex items-start space-x-6">
              ...
              <div>
                ...
                <a href="tel:+911234567890" className="mt-1 text-brand-teal hover:underline">
                  {`${environment?.phoneNumber1}`}
                </a>
              </div>
            </div>
          </motion.div>
